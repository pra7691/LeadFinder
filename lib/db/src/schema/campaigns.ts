...
export const campaignsTable = pgTable("campaigns", {
  ...
  discoveryInputMode: text("discovery_input_mode").notNull().default("search"),
  uploadedDomains: text("uploaded_domains").notNull().default(""),
  uploadedDomainsApplyBlockLogic: boolean("uploaded_domains_apply_block_logic").notNull().default(true),
