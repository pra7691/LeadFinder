...
export const ListCampaignsResponseItem = zod.object({
  ...
  "discoveryInputMode": zod.enum(['search', 'upload']).default('search'),
  "uploadedDomains": zod.string().default(''),
  "uploadedDomainsApplyBlockLogic": zod.boolean().default(true),
...
export const UpdateCampaignBody = zod.object({
  ...
  "discoveryInputMode": zod.enum(['search', 'upload']).optional(),
  "uploadedDomains": zod.string().optional(),
  "uploadedDomainsApplyBlockLogic": zod.boolean().optional(),
...
export const GetCampaignRunLeadsResponseItem = zod.object({
  ...
  "browserStatus": zod.string().nullish().describe('Browser fallback status for this lead when a retry attempt exists'),
  "browserError": zod.string().nullish().describe('Stored Playwright browser retry or setup error'),
  "browserAttemptedAt": zod.string().nullish().describe('Browser attempt start time, or queue time when setup prevented launch'),
